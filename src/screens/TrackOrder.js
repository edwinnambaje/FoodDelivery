                    ...
                    {orders.sort(
                        ...
                        return (
                            <View style={styles.order} key={index}>
                                            ...
                                            <View style={styles.rowout}>
                                                <View style={styles.row}>
                                                    <View style={styles.left}>
                                                        ...
                                                        <Text style={styles.price1}>Rwf{item.data.foodPrice}</Text>
                                                    </View>
                                                    <View style={styles.right}>
                                                        <Text style={styles.totalprice}>Rwf{parseInt(item.Foodquantity) * parseInt(item.data.foodPrice)}</Text>
                                                    </View>
                                                </View>
                                                ...
                                                <View style={styles.row}>
                                                    <View style={styles.left}>
                                                        ...
                                                        <Text style={styles.price1}>Rwf{item.data.foodAddonPrice}</Text>
                                                    </View>
                                                    <View style={styles.right}>
                                                        <Text style={styles.totalprice}>Rwf{parseInt(item.Addonquantity) * parseInt(item.data.foodAddonPrice)}</Text>
                                                    </View>
                                                </View>
                                            </View>
                                        )
                                ...
                                <Text style={styles.total}>Total: Rwf{order.ordercost}</Text>
                                {
